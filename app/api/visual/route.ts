...
<text x="${x+14}" y="86" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="9" fill="#050810" font-weight="700">${i+1}</text>
<text x="${x+w/2}" y="${line2 ? '108' : '113'}" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="10.5" fill="#E8F0FC" font-weight="600">${line1}</text>
${line2 ? `<text x="${x+w/2}" y="122" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="10.5" fill="#E8F0FC">${line2}</text>` : ''}`
    if (i < n - 1) {
      const ax = x + w + 2
...
<text x="${x+69}" y="100" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="11" fill="#E8F0FC" font-weight="700">${head.slice(0,16)}</text>
<text x="${x+69}" y="118" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="9" fill="#8EA8CC">${sub.slice(0,20)}</text>
<text x="${x+69}" y="145" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="9" fill="#8EA8CC">${sub.slice(20,40)}</text>`
  }
  return out
}
...
<text x="${x+w/2}" y="100" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="28" fill="url(#${gIds[i]})" font-weight="800" filter="url(#glow)">${val.slice(0,10)}</text>
<text x="${x+w/2}" y="118" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="9.5" fill="#8EA8CC" letter-spacing="0.06em">${label.slice(0,18).toUpperCase()}</text>
<line x1="${x+w*0.2}" y1="128" x2="${x+w*0.8}" y2="128" stroke="url(#${gIds[i]})" stroke-width="1.5" opacity="0.6"/>
<text x="${x+w/2}" y="148" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="8.5" fill="#4A6285">${desc.slice(0,20)}</text>`
  }
  return out
}
...
<text x="${x+18}" y="${ys[i]+17}" font-family="Montserrat,sans-serif" font-size="11" fill="#E8F0FC" font-weight="700">${head.slice(0,22)}</text>
<text x="${x+18}" y="${ys[i]+32}" font-family="Montserrat,sans-serif" font-size="9" fill="#8EA8CC">${note.slice(0,40)}</text>`
  }
  return out
}
...
<text x="260" y="101" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="11" fill="#4ECDC4" font-weight="700">${centre.slice(0,14)}</text>
<text x="260" y="116" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="9" fill="#8EA8CC">${centre.slice(14,28)}</text>`
  for (let i = 0; i < n; i++) {
...
<text x="${sx}" y="${sy-3}" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="10" fill="#E8F0FC" font-weight="600">${line1}</text>
${line2 ? `<text x="${sx}" y="${sy+11}" text-anchor="middle" font-family="Montserrat,sans-serif" font-size="10" fill="#8EA8CC">${line2}</text>` : ''}`
  }
  return out
}
...
${DEFS}
<text x="16" y="15" font-family="Montserrat,sans-serif" font-size="9" fill="#4A6285" letter-spacing="0.14em" font-weight="600">${title.toUpperCase().slice(0, 36)}</text>
${body}
</svg>`
}
